...
<?php echo $this->Form->create('Professional'); ?>
	<fieldset>
		<legend><?php echo __('Edit Professional'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Professional.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Professional.id'))); ?></li>
