...
<?php echo $this->Form->create('MembersLocker'); ?>
	<fieldset>
		<legend><?php echo __('Edit Members Locker'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MembersLocker.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MembersLocker.id'))); ?></li>
