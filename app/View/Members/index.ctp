<div class="members index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('member_first_name'); ?></th>
			<th><?php echo $this->Paginator->sort('member_last_name'); ?></th>
			<th><?php echo $this->Paginator->sort('member_email'); ?></th>
			<th><?php echo $this->Paginator->sort('member_address'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($member['Member']['member_first_name']); ?>&nbsp;</td>
		<td><?php echo h($member['Member']['member_last_name']); ?>&nbsp;</td>
