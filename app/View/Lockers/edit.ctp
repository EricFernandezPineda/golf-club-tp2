...
<?php echo $this->Form->create('Locker'); ?>
	<fieldset>
		<legend><?php echo __('Edit Locker'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Locker.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Locker.id'))); ?></li>
